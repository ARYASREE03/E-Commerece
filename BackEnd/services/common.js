...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'randomtestuser24@gmail.com', // gmail
...
return timezones[timezone].currency ? timezones[timezone].currency : "₹";
};
...
exports.sendMail = async function ({to, subject, text, html}){
    let info = await transporter.sendMail({
        from: '"E-commerce" <randomtestuser24@gmail.com>', // sender address
        to: 'randomtestuser24@gmail.com',
        subject,
        text,
        html
      });
            ...
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                ${order.items.map(item=>`<tr>
                  ...
                  <td align="left" width="20%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">${getCurrencySymbol()}${Math.round(item.product.price*(1-item.product.discountPercentage/100),2)}</td>
                </tr>`)
                ...
                <tr>
                  ...
                  <td align="left" width="20%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>${getCurrencySymbol()}${order.totalAmount}</strong></td>
                </tr>
              </table>
            </td>
          </tr>
